...
public class PermissionsUtil {
    ...
    public static String CORASE_LOCATION=Manifest.permission.ACCESS_COARSE_LOCATION;
    public static String WIFI=Manifest.permission.ACCESS_WIFI_STATE;
    ...
    static String wifiPermErrorMsg = "Wifi permission denied. You can enable permission from settings";
    static String wifiPermInfoMsg = "App needs this permission to access your Wifi networks. Are you sure you want to deny this permission ?";
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(context, permission)) {
                    ...
                    if (permission.equals(STORAGE))
                        ...
                        alertBuilder.setMessage(contactsPermInfoMsg);
                    else if (permission.equals(CORASE_LOCATION))
                        alertBuilder.setMessage(context.getString(R.string.location_permission));
                    else if (permission.equals(WIFI))
                        alertBuilder.setMessage(wifiPermErrorMsg);
                    ...
                    if (permission.equals(STORAGE))
                        ...
                        Toast.makeText(context, wifiPermErrorMsg, Toast.LENGTH_LONG).show();
                    else if(permission.equals(CORASE_LOCATION))
                        Toast.makeText(context, locationPermErrorMsg, Toast.LENGTH_LONG).show();
                    permissionListener.onPermissionResult(false);
                }
