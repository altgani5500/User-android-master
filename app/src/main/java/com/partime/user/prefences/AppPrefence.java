package com.partime.user.prefences;
...
public enum AppPrefence {
    ...
    private static final String SHARED_PREFERENCE_NAME = "parttimeapp";
...
*/
    ...
    public enum SharedPreferncesKeys {
        appVersion, IS_FIRST_TIME_LAUNCH, languageSreen,
        API_TOKEN, username, IS_LOGIN, DEVICE_TOKEN, USER_ID,
        LANGUAGE, currentLat, currentLong, saveJobHome, saveHomeJobId, applyJobHome,
        applyHomeJobId, currentAddOne, currentAddTwo, FROM_HOME, industryFilter, jobTitleFilter, companyFilter,
        cityFilter, stateFilter, countryFilter, currentLocation, hourweekFilter, hourRateFilter, hourPaidRateFilter,
        jobtypeFilter, taskDetailId, taskDetailStatus,ENROLLED_E_ID,IS_PUNCH_IN,IS_ENROLLED
    }
}