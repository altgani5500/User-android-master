...
public class EventCountCellView extends BaseCellView {
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            ...
            eventBackground = a.getColor(R.styleable.EventCountCellView_event_background, getResources().getColor(android.R.color.black));
            eventTextColor = a.getColor(R.styleable.EventCountCellView_event_count_text_color, getResources().getColor(android.R.color.black));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mEventCount > 0) {
            ...
            eventCircleY = (getHeight() - rect.height()) ;
            eventCircleX = (2 * getWidth() + rect.width()) / 4;
